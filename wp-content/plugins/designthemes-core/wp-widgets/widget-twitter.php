<?php
class Pallikoodam_Twitter extends WP_Widget {
	#1.constructor
	function __construct() {
		...
		parent::__construct(false,PALLIKOODAM_THEME_NAME.esc_html__(' Twitter Widget','dt-elementor'),$widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo pallikoodam_before_after_widget( $before_widget );
			...
			if($username && $consumer_key && $consumer_secret && $access_token && $access_token_secret && $count) { 
					...
					require_once(PALLIKOODAM_CORE_PLUGIN."/apis/twitteroauth/twitteroauth.php");
