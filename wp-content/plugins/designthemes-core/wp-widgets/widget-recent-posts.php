<?php
class Pallikoodam_Recent_Posts extends WP_Widget {
	#1.constructor
	function __construct() {
		...
		parent::__construct(false,PALLIKOODAM_THEME_NAME.esc_html__(' Posts','dt-elementor'),$widget_options);
	}
				...
				echo "<li>";
					...
					echo '<div class="entry-content-wrapper">';
						...
						echo '<div class="entry-meta">';
							echo '<p>'.get_the_date('M').' '.get_the_date('d').', '.get_the_date('Y').'</p>';
							$commtext = "";
