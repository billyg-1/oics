...
class DTPortfolioAddonPostType {
	...
	function createPostType() {
		...
		$tag_slug = dtportfolio_get_option( 'portfolio-tag-slug', 'portfolio-tags' );
	...
	function dtportfolio_portfolio_cs_metabox_options( $options ) {
		...
		$custom_field_1 = pallikoodam_get_option( 'dt-portfolio-custom-field-1' );
		array_push($custom_fields, $custom_field_1);

		$custom_field_2 = pallikoodam_get_option( 'dt-portfolio-custom-field-2' );
		array_push($custom_fields, $custom_field_2);

		$custom_field_3 = pallikoodam_get_option( 'dt-portfolio-custom-field-3' );
		array_push($custom_fields, $custom_field_3);

		$custom_field_4 = pallikoodam_get_option( 'dt-portfolio-custom-field-4' );
		array_push($custom_fields, $custom_field_4);

		$custom_field_5 = pallikoodam_get_option( 'dt-portfolio-custom-field-5' );
