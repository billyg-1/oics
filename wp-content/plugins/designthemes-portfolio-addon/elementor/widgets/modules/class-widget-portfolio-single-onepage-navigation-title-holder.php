		...
		<script type="text/javascript">
			...
			jQuery(document).ready(function($) {
				...
				jQuery(window).on('load', function(){
					...
					jQuery('.dtportfolio-onepage-navigation-title-holder li a').click(function(event) {

						console.log('nnnnn');

					jQuery('.dtportfolio-onepage-navigation-title-holder li a').removeClass('active');
