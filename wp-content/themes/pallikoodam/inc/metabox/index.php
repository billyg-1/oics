...
class DT_Metabox {
	...
	public function __construct() {
		...
		define( 'DTM_URL', PALLIKOODAM_THEME_URI.'/inc/metabox/' );
		define( 'DTM_PATH', PALLIKOODAM_THEME_DIR.'/inc/metabox/' );
	...
	public function load_plugin_textdomain() {
		load_plugin_textdomain( 'pallikoodam', false, get_theme_file_path() . '/languages/' );
	}
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'pallikoodam' ), '1.0.0' );
	}
