...
class DTMFramework_Option_typography extends DTMFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. esc_attr__( 'Web Safe Fonts', 'pallikoodam' ) .'">';
      ...
      echo '<optgroup label="'. esc_attr__( 'Google Fonts', 'pallikoodam' ) .'">';
      ...
      echo esc_html__( 'Error! Can not load json file.', 'pallikoodam' );
