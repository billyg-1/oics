...
class DTMFramework_Option_group extends DTMFramework_Options {
  ...
  public function output() {
    ...
    $acc_title   = ( isset( $this->field['accordion_title'] ) ) ? $this->field['accordion_title'] : esc_html__( 'Adding', 'pallikoodam' );
    ...
    echo '<div class="cs-group cs-group-'. $el_class .'-adding hidden">';
      ...
      echo '<div class="cs-element cs-text-right cs-remove"><a href="#" class="button cs-warning-primary cs-remove-group">'. esc_html__( 'Remove', 'pallikoodam' ) .'</a></div>';
      echo '</div>';
