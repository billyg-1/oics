...
if( ! function_exists( 'dtm_admin_enqueue_scripts' ) ) {
  function dtm_admin_enqueue_scripts() {
    ...
    wp_enqueue_style( 'pallikoodam', DTM_URI .'/assets/css/cs-framework.css', array(), '1.0.0', 'all' );
    ...
    wp_enqueue_script( 'pallikoodam',  DTM_URI .'/assets/js/cs-framework.js',  array( 'dtm-plugins' ), '1.0.0', true );
