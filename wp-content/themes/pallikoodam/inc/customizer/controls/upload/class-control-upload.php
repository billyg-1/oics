<?php
/**
 * PALLIKOODAM Theme Customizer Control: Upload
 *
 */
...
class PALLIKOODAM_Customize_Control_Upload extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'pallikoodam-upload-control',  PALLIKOODAM_THEME_URI . '/inc/customizer/controls/upload/upload.css', null, PALLIKOODAM_THEME_VERSION );
		wp_enqueue_script( 'pallikoodam-upload-control', PALLIKOODAM_THEME_URI . '/inc/customizer/controls/upload/upload.js', array( 'jquery', 'customize-base' ), PALLIKOODAM_THEME_VERSION, true );
	}
                ...
                <div class="upload-file">
                    <div class="attachment-file-view upload-file">
                        ...
                        <div class="actions">
                            ...
                            <button type="button" class="button upload-file-button"><?php esc_attr_e( 'Select File', 'pallikoodam' ); ?></button>
                        </div>
                    </div>
                </div>
			</div>
