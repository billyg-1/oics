<?php
/**
 * PALLIKOODAM Theme Customizer Control: Responsive Number Field
 *
 */
...
class PALLIKOODAM_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'pallikoodam-responsive-number-control', PALLIKOODAM_THEME_URI . '/inc/customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), PALLIKOODAM_THEME_VERSION, true );
		wp_enqueue_style( 'pallikoodam-responsive-number-control',  PALLIKOODAM_THEME_URI . '/inc/customizer/controls/responsive-number/responsive-number.css', null, PALLIKOODAM_THEME_VERSION );
	}
