<?php
/**
 * PALLIKOODAM Theme Customizer Control: Responsive slider
 *
 */
...
class PALLIKOODAM_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'pallikoodam-responsive-slider-control', PALLIKOODAM_THEME_URI . '/inc/customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), PALLIKOODAM_THEME_VERSION, true );
		wp_enqueue_style( 'pallikoodam-responsive-slider-control',  PALLIKOODAM_THEME_URI . '/inc/customizer/controls/responsive-slider/responsive-slider.css', null, PALLIKOODAM_THEME_VERSION );
	}
