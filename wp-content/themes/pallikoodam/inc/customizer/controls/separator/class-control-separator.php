<?php
/**
 * PALLIKOODAM Theme Customizer Control: separator
 *
 */
...
class PALLIKOODAM_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'pallikoodam-separator-control',  PALLIKOODAM_THEME_URI . '/inc/customizer/controls/separator/separator.css', null, PALLIKOODAM_THEME_VERSION );
	}	
