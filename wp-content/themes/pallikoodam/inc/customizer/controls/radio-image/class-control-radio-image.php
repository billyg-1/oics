<?php
/**
 * PALLIKOODAM Theme Customizer Control: radio-image
 *
 */
...
class PALLIKOODAM_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'pallikoodam-radio-image-control', PALLIKOODAM_THEME_URI . '/inc/customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), PALLIKOODAM_THEME_VERSION, true );
		wp_enqueue_style( 'pallikoodam-radio-image-control',  PALLIKOODAM_THEME_URI . '/inc/customizer/controls/radio-image/radio-image.css', null, PALLIKOODAM_THEME_VERSION );
	}
