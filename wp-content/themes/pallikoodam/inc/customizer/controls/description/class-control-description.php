<?php
/**
 * PALLIKOODAM Theme Customizer Control: description
 *
 */
...
class PALLIKOODAM_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'pallikoodam-description-control',  PALLIKOODAM_THEME_URI . '/inc/customizer/controls/description/description.css', null, PALLIKOODAM_THEME_VERSION );
	}	
