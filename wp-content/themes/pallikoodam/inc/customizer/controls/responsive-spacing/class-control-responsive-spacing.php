<?php
/**
 * PALLIKOODAM Theme Customizer Control: Responsive Spacing Field
 *
 */
...
class PALLIKOODAM_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'pallikoodam-responsive-spacing-control', PALLIKOODAM_THEME_URI . '/inc/customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), PALLIKOODAM_THEME_VERSION, true );
		wp_enqueue_style( 'pallikoodam-responsive-spacing-control',  PALLIKOODAM_THEME_URI . '/inc/customizer/controls/responsive-spacing/responsive-spacing.css', null, PALLIKOODAM_THEME_VERSION );
	}
