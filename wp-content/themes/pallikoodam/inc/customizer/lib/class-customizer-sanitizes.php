<?php
/**
 * PALLIKOODAM Theme Customizer Sanitizes
 * 
 * @link  https://divpusher.com/blog/wordpress-customizer-sanitization-examples
 */

if( !class_exists('PALLIKOODAM_Customizer_Sanitizes') ) {

	class PALLIKOODAM_Customizer_Sanitizes {
...
PALLIKOODAM_Customizer_Sanitizes::get_instance();