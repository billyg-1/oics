...
if ( ! class_exists( 'PALLIKOODAM_Font_Families' ) ) {

	class PALLIKOODAM_Font_Families {
		...
		public static function get_google_fonts() {
			...
			#$google_fonts_file = PALLIKOODAM_THEME_DIR . '/inc/customizer/assets/json/google-fonts.json';
			$google_fonts_file = PALLIKOODAM_THEME_DIR . '/inc/customizer/assets/json/google-fonts-1.json';
