 ...
 */
	$wp_customize->add_setting(
		PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-layout]', array(
			'default'           => pallikoodam_get_option( 'dt-woo-category-archive-layout' ),
			'type'              => 'option',
	...
	$wp_customize->add_control(
		new PALLIKOODAM_Customize_Control_Radio_Image(
			$wp_customize, PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-layout]', array(
				'type'     => 'dt-radio-image',
				'label'    => esc_html__( 'Layout', 'pallikoodam'),
				'section'  => 'woocommerce-category-archive-section',
				'choices'  => apply_filters( 'pallikoodam_category_archive_layout_options', array(
 ...
 */
	$wp_customize->add_setting(
		PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-show-standard-sidebar]', array(
			'default'           => pallikoodam_get_option( 'dt-woo-category-archive-show-standard-sidebar' ),
			'type'              => 'option',
	...
	$wp_customize->add_control(
		new PALLIKOODAM_Customize_Control_Switch(
			$wp_customize, PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-show-standard-sidebar]', array(
				'type'    => 'dt-switch',
 ...
 */
	$wp_customize->add_setting(
		PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-widgetareas]', array(
			'default'           => pallikoodam_get_option( 'dt-woo-category-archive-widgetareas' ),
			'type'              => 'option',
			'sanitize_callback' => array( 'PALLIKOODAM_Customizer_Sanitizes', 'sanitize_choices' ),
		)
	);
	...
	$wp_customize->add_control(
		PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-widgetareas]', array(
			...
			'section'  => 'woocommerce-category-archive-section',
			'choices'  => apply_filters( 'pallikoodam_category_archive_widgetareas', pallikoodam_customizer_custom_widgets() ),
			'dependency' => array( 'dt-woo-category-archive-layout', 'any', 'with-left-sidebar,with-right-sidebar' )
		)
	);
 ...
 */
	$wp_customize->add_setting(
		PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-product-per-page]', array(
			'default'           => pallikoodam_get_option( 'dt-woo-category-archive-product-per-page' ),
			'type'              => 'option',
 ...
 */
	$wp_customize->add_setting(
		PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-product-layout]', array(
			'default'           => pallikoodam_get_option( 'dt-woo-category-archive-product-layout' ),
			'type'              => 'option',
			'sanitize_callback' => array( 'PALLIKOODAM_Customizer_Sanitizes', 'sanitize_choices' ),
		)
	);
	...
	$wp_customize->add_control(
		new PALLIKOODAM_Customize_Control_Radio_Image(
			$wp_customize, PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-product-layout]', array(
				'type'     => 'dt-radio-image',
				'label'    => esc_html__( 'Product Layout', 'pallikoodam'),
				'section'  => 'woocommerce-category-archive-section',
				'choices'  => apply_filters( 'pallikoodam_category_archive_product_layout_options', array(
 ...
 */
	$wp_customize->add_setting(
		PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-product-style-template]', array(
			'default'           => pallikoodam_get_option( 'dt-woo-category-product-style-template' ),
			'type'              => 'option',
			'sanitize_callback' => array( 'PALLIKOODAM_Customizer_Sanitizes', 'sanitize_choices' ),
		)
	);
	...
	$wp_customize->add_control(
		new PALLIKOODAM_Customize_Control(
			$wp_customize, PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-product-style-template]', array(
				'type'     => 'select',
 ...
 */
	$wp_customize->add_setting(
		PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-enable-breadcrumb]', array(
			'default'           => pallikoodam_get_option( 'dt-woo-category-archive-enable-breadcrumb' ),
			'type'              => 'option',
			'sanitize_callback' => array( 'PALLIKOODAM_Customizer_Sanitizes', 'sanitize_tweek' ),
		)
	);
	...
	$wp_customize->add_control(
		new PALLIKOODAM_Customize_Control_Switch(
			$wp_customize, PALLIKOODAM_THEME_SETTINGS . '[dt-woo-category-archive-enable-breadcrumb]', array(
				'type'    => 'dt-switch',
