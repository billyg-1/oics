...
$ele_pos = pallikoodam_get_option( 'post-elements-position' );
foreach( $ele_pos as $ep ) {
	$element_position[$ep] = $ep;
}

$meta_pos = pallikoodam_get_option( 'post-meta-position' );
...
foreach( $element_position as $key => $value ):
	...
	elseif( $key == 'content' ):
		...
		pallikoodam_get_template( $template );
		...
		<div class="entry-meta-group"><?php
			...
			foreach( $meta_group_position as $key => $value ):
				...
				if( $key == 'author' ):
					...
					$template = 'framework/templates/single/entry-author.php'; ?><!-- Entry Author --><div class="entry-author"><?php 
						pallikoodam_get_template( $template, $template_args );
					?></div><!-- Entry Author --><?php

				elseif( $key == 'date' ):

					$template = 'framework/templates/single/entry-date.php'; ?><!-- Entry Date --><div class="entry-date"><?php 
						pallikoodam_get_template( $template, $template_args );
					?></div><!-- Entry Date --><?php

				elseif( $key == 'comments' ):

					$template = 'framework/templates/single/entry-comment.php'; ?><!-- Entry Comment --><div class="entry-comments"><?php 
						pallikoodam_get_template( $template, $template_args );
					?></div><!-- Entry Comment --><?php

				elseif( $key == 'categories' ):

					$template = 'framework/templates/single/entry-categories.php'; ?><!-- Entry Categories --><div class="entry-categories"><?php 
						pallikoodam_get_template( $template, $template_args );
					?></div><!-- Entry Categories --><?php

				elseif( $key == 'tags' && has_tag() ):

					$template = 'framework/templates/single/entry-tags.php'; ?><!-- Entry Tags --><div class="entry-tags"><?php 
						pallikoodam_get_template( $template, $template_args );
					?></div><!-- Entry Tags --><?php
				...
				elseif( $key == 'likes_views' ):
					...
					$template = 'framework/templates/single/entry-likes-views.php'; ?><!-- Entry Likes Views --><div class="entry-likes-views"><?php 
						pallikoodam_get_template( $template, $template_args );
					?></div><!-- Entry Likes Views --><?php
