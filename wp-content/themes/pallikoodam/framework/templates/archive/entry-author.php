...
<?php
	if( $post_Style == 'dt-sc-boxed-style' ): ?>
		<span><?php esc_html_e('By', 'pallikoodam'); ?></span>
        <?php echo get_avatar( get_the_author_meta( 'ID' ), 50 ); ?>
		<a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" title="<?php esc_attr_e('View all posts by ', 'pallikoodam'); echo get_the_author();?>">
	...
	elseif( $post_Style == 'dt-sc-classic-style' || $post_Style == 'dt-sc-classic-ii-style' ): ?>
        ...
        <a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" 
            title="<?php esc_attr_e('View all posts by ', 'pallikoodam'); echo get_the_author();?>"><?php echo get_the_author();?></a><?php
	else: ?>
