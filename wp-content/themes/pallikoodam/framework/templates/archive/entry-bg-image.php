<?php if ( ! defined( 'ABSPATH' ) ) { exit; }
	...
	elseif( has_post_thumbnail( $post_ID ) ) :
		...
		<a <?php echo esc_attr($entry_bg);?> href="<?php echo get_permalink( $post_ID );?>" title="<?php printf(esc_attr__('Permalink to %s','pallikoodam'), the_title_attribute('echo=0'));?>"></a><?php
	endif;