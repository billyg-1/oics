<?php if ( ! defined( 'ABSPATH' ) ) { exit; }
	...
	$img_size = array( 'one-column' => 'pallikoodam-blog-i-column', 'one-half-column' => 'pallikoodam-blog-ii-column', 'one-third-column' => 'pallikoodam-blog-iii-column', 'one-fourth-column' => 'pallikoodam-blog-iv-column' );
	...
	elseif( has_post_thumbnail( $post_ID ) ) : ?>
		<a href="<?php echo get_permalink($post_ID);?>" title="<?php printf(esc_attr__('Permalink to %s','pallikoodam'), the_title_attribute('echo=0'));?>">
