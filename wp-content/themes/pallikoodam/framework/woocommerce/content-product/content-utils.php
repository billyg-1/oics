...
function pallikoodam_woo_loop_product_thumb_content_setup($product_thumb_contents) {
	...
	if(!empty($product_thumb_contents)) {
		...
		foreach($product_thumb_contents as $product_thumb_content_key => $product_thumb_content) {
			...
			add_action('dt_woo_loop_product_thumb_content', 'pallikoodam_woo_loop_product_content_'.$product_thumb_content_key, $i, 1);
...
function pallikoodam_woo_loop_product_content_content_setup($product_content_contents) {
	...
	if(!empty($product_content_contents)) {
		...
		foreach($product_content_contents as $product_content_content_key => $product_content_content) {
			...
			add_action('dt_woo_loop_product_content_content', 'pallikoodam_woo_loop_product_content_'.$product_content_content_key, $i, 1);
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_title' ) ) {
	
	function pallikoodam_woo_loop_product_content_title() {

		global $product;
		echo '<div class="product-title"><h5><a href="'.esc_url($product->get_permalink()).'">'.pallikoodam_html_output($product->get_name()).'</a></h5></div>';
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_excerpt' ) ) {
	
	function pallikoodam_woo_loop_product_content_excerpt() {

		global $product;
		if($product->get_short_description() != '') {
			echo '<div class="product-short-description">'.pallikoodam_html_output($product->get_short_description()).'</div>';
		}
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_rating' ) ) {
	
	function pallikoodam_woo_loop_product_content_rating() {
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_category' ) ) {
	
	function pallikoodam_woo_loop_product_content_category() {
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_price' ) ) {
	
	function pallikoodam_woo_loop_product_content_price() {
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_button_element' ) ) {
	
	function pallikoodam_woo_loop_product_content_button_element($location) {
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_countdown' ) ) {
	
	function pallikoodam_woo_loop_product_content_countdown() {
		...
		if($countdown != '') {
			echo '<div class="product-countdown-wrapper">'.pallikoodam_html_output($countdown).'</div>';
		}
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_swatches' ) ) {
	
	function pallikoodam_woo_loop_product_content_swatches() {
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_icons_group' ) ) {
	
	function pallikoodam_woo_loop_product_content_icons_group($location) {
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_separator' ) ) {
	
	function pallikoodam_woo_loop_product_content_separator() {
...
if( ! function_exists( 'pallikoodam_woo_loop_product_content_element_group' ) ) {
	
	function pallikoodam_woo_loop_product_content_element_group($location) {
		...
		if($product_element_group) {
			...
			echo '<div class="product-element-group-wrapper">';
				...
				if(in_array('title', $product_element_group)) {
					ob_start();
					pallikoodam_woo_loop_product_content_title();
					$title = ob_get_clean();
				}
				...
				if(in_array('price', $product_element_group)) {
					ob_start();
					pallikoodam_woo_loop_product_content_price();
					$price = ob_get_clean();
				}
				...
				if(in_array('category', $product_element_group)) {
					ob_start();
					pallikoodam_woo_loop_product_content_category();
				...
				if(in_array('button_element', $product_element_group)) {
					ob_start();
					pallikoodam_woo_loop_product_content_button_element($location);
				...
				if(in_array('icons_group', $product_element_group)) {
					ob_start();
					pallikoodam_woo_loop_product_content_icons_group($location);
				...
				if(in_array('excerpt', $product_element_group)) {
					ob_start();
					pallikoodam_woo_loop_product_content_excerpt();
				...
				if(in_array('rating', $product_element_group)) {
					ob_start();
					pallikoodam_woo_loop_product_content_rating();
					$rating = ob_get_clean();
				}
				...
				if(in_array('separator', $product_element_group)) {
					ob_start();
					pallikoodam_woo_loop_product_content_separator();
				...
				echo '<div class="product-element-group-items">';
					...
					$i = 1;
					foreach ($product_element_group as $key => $value) {
						echo pallikoodam_html_output($$value);
