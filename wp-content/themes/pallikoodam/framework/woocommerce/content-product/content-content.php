...
if( ! function_exists( 'pallikoodam_woo_loop_product_content' ) ) {
	
	function pallikoodam_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				pallikoodam_woo_loop_product_content_content_setup($product_content_content);
	...
	add_action( 'woocommerce_shop_loop_item_title', 'pallikoodam_woo_loop_product_content', 10 );
