...
$heading = esc_html( apply_filters( 'woocommerce_product_description_heading', esc_html__( 'Description', 'pallikoodam' ) ) );

?>

<?php if ( $heading ) : ?>
  <h2><?php echo pallikoodam_html_output($heading); ?></h2>
<?php endif; ?>
